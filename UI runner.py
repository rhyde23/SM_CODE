...
for team in teams_in_league :
    ...
    team_logos[team] = pygame.transform.scale(loaded_image_logo, (40, 40))
    team_simming_logos = pygame.transform.scale(loaded_image_logo, (70, 70))

user_logo = team_simming_logos[team]
user_logo_text = myfont.render(team, True, white)
user_logo_text_width = user_logo_text.get_width()
            ...
            if simming :
                ...
                if simming_count == 50 :
                    ...
                    if next_month :
                        ...
                        dates_of_games_in_month = get_games_in_a_month(month, schedule_dict, team)
                    try :
                        opponent, stadium, left_or_right = dates_of_games_in_month[without_year]
                        stadium_text = myfont.render(stadium, True, white)
